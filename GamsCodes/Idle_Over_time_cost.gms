* Gams code for the problem size: 4×24 (for the first Objective: minimize Idle/Over time costs)
...
parameter T(r);
$ call gdxxrw  schedule.xlsx par T rng=Sheet1!t38:u45 rdim=1 cdim=0
$ gdxin schedule.gdx
$ load T
$gdxin

parameter I(r);
$ call gdxxrw  schedule.xlsx par I rng=Sheet1!q38:r45 rdim=1 cdim=0
$ gdxin schedule.gdx
$ load I
$gdxin
...
parameter ST(r);
$ call gdxxrw  schedule.xlsx par ST rng=Sheet1!x38:y45 rdim=1 cdim=0
$ gdxin schedule.gdx
$ load ST
$gdxin
...
display z.l, Ov.l,Id.l,f.l,a.l,x.l,Fx.l,v.l,Fv.l;
display e,I,T,d;
